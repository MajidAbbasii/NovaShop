    ...
    <div className='space-y-4'>
      <PageHeader
        ...
        actions={
          <Button onClick={() => router.push('/admin/products/new')}>
            <PlusIcon className='size-4' /> محصول جدید
          </Button>
        }
      />
      ...
      <div className='flex flex-wrap items-center gap-2'>
        ...
        {hasFilters && (
          <Button variant='ghost' size='sm' onClick={clearFilters}>
            <XIcon className='size-3.5' /> پاک‌کردن فیلترها
          </Button>
        )}
      </div>
      ...
      <div className='overflow-hidden rounded-xl border bg-card'>
        {error ? (
          ...
          <EmptyState
            title={hasFilters ? 'محصولی matching filters یافت نشد' : 'هنوز محصولی ثبت نشده است'}
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align='end' className='w-40'>
                          <DropdownMenuItem onClick={() => router.push(`/admin/products/${p.id}`)}>
                            <EyeIcon className='size-4' /> مشاهده
                          </DropdownMenuItem>
