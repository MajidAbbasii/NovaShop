    ...
    public partial class InitialCreatePostgres : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<int>(type: "integer", nullable: false),
                    CourierPrice = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    PostPrice = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    PostFreeShippingThreshold = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    PickupPrice = table.Column<decimal>(type: "numeric(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            // PostgreSQL full-text search: a STORED generated tsvector column maintained
            // automatically on every INSERT/UPDATE (no rebuild job required), indexed with GIN.
            migrationBuilder.Sql(
                "ALTER TABLE \"Products\" ADD COLUMN \"SearchVector\" tsvector GENERATED ALWAYS AS (to_tsvector('simple', coalesce(\"Name\", '') || ' ' || coalesce(\"Description\", ''))) STORED;");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdminMessage = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReservationExpiresAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ...
                    RefundProcessed = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomDollRequestId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.CustomDollRequestId,
