...
public class GetMyCustomDollRequestDetailQueryHandler : IRequestHandler<GetMyCustomDollRequestDetailQuery, CustomDollRequestDetailResponse?>
{
    private readonly NovaShopDbContext _context;

    public GetMyCustomDollRequestDetailQueryHandler(NovaShopDbContext context)
    {
        _context = context;
    }

    public async Task<CustomDollRequestDetailResponse?> Handle(GetMyCustomDollRequestDetailQuery request, CancellationToken ct)
    {
